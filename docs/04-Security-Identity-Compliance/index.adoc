...
The LZA Universal Configuration applies two preventive guardrails to the LZA Deployment OU for accounts hosting container-based LZA deployments.

NOTE: These SCPs are applicable only to container-based LZA deployments. Standard AWS CodePipeline-based deployments do not require these policies.

*Operator Actions Permitted*::
Operators in the LZA Deployment account can:
