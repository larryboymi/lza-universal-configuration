...
NOTE: This OU is applicable only to container-based LZA deployments and is added through partition-specific configuration replacements. Standard AWS CodePipeline-based deployments do not use this OU.
...
NOTE: This account is applicable only to container-based LZA deployments and is added through partition-specific configuration replacements. Standard AWS CodePipeline-based deployments do not require a separate deployment account.
