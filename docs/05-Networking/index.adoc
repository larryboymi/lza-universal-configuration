...
NOTE: Sandbox accounts have no LZA-managed VPC and therefore no DNS Firewall association. This is by design — Sandbox allows unrestricted DNS for rapid iteration.
